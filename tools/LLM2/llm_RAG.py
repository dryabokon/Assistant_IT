...
# ----------------------------------------------------------------------------------------------------------------------
    def texts_to_docs(self,texts):
        ...
        return docs
# ----------------------------------------------------------------------------------------------------------------------
    def do_docsearch_azure(self, query,azure_search_index_name,select='text',as_doc=True,limit=4):
        self.azure_search.search_client = self.azure_search.get_search_client(azure_search_index_name)
        ...
        return docs
# ----------------------------------------------------------------------------------------------------------------------
    def do_docsearch_azure_hybrid(self, query, azure_search_index_name, search_field='token', select='text',as_doc=True,limit=4):
        self.azure_search.search_client = self.azure_search.get_search_client(azure_search_index_name)
